...
export const GALLERY_PHOTOS = [
  ...
  { src: 'images/gallery/my-campus.jpg',         country: 'malaysia',  title: 'Heriot-Watt University Malaysia — Putrajaya', desc: 'The waterfront HWUM campus on Putrajaya Lake, home to the lecture halls, labs and student community you will join.' },
  { src: 'images/gallery/my-class-briefing.jpg', country: 'malaysia',  title: 'Summer Programme Briefing — Computer Lab',  desc: 'Students attending the induction briefing for the Short Study Programme in one of the campus\'s computer labs.' },
  { src: 'images/gallery/my-group-launch.jpg',   country: 'malaysia',  title: 'Summer Programme — Opening Day',            desc: 'Students and HWUM staff gathered on the campus steps for the official welcome of the Summer Programme cohort.' },
  { src: 'images/gallery/my-nasi-lemak.jpg',     country: 'malaysia',  title: 'Nasi Lemak — Malaysia\'s National Dish',    desc: 'Coconut rice with sambal, fried anchovies, peanuts, cucumber and a boiled egg — a breakfast staple all across Malaysia.' },
  { src: 'images/gallery/my-chicken-rice.jpg',   country: 'malaysia',  title: 'Hainanese Chicken Rice',                    desc: 'Poached chicken and fragrant rice cooked in chicken stock, served with chilli and soy dipping sauces.' },

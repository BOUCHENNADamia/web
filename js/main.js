...
const GALLERY_PHOTOS = [
  ...
  { src: 'images/gallery/ch-Chin-Lin.jpg', country: 'china',
    title: 'Chi Lin Nunnery — Hong Kong',
    desc: 'A tranquil Buddhist nunnery complex featuring stunning wooden architecture and lotus ponds.' },
  { src: 'images/gallery/ch-Chin-Lin2.jpg', country: 'china',
    title: 'Chi Lin Nunnery Gardens — Hong Kong',
    desc: 'A closer look at the traditional Chinese architectural details within the nunnery grounds.' },
  { src: 'images/gallery/ch-Hong-Kong.jpg', country: 'china',
    title: 'Hong Kong Skyline',
    desc: 'The breathtaking panoramic view of the world-famous Hong Kong skyline across Victoria Harbour.' },
  { src: 'images/gallery/ch-Hong-kong2.jpg', country: 'china',
    title: 'Victoria Harbour — Hong Kong',
    desc: 'A vibrant scene looking out across the bustling waters of Victoria Harbour.' },
  { src: 'images/gallery/ch-Lianhuashan-park.jpg', country: 'china',
    title: 'Lianhuashan Park — Shenzhen',
    desc: 'A popular hilltop park offering panoramic views of the modern Shenzhen cityscape.' },
  { src: 'images/gallery/ch-Nan-Lian.jpg', country: 'china',
    title: 'Nan Lian Garden — Hong Kong',
    desc: 'A beautifully landscaped Chinese classical garden located in the heart of the city.' },
  { src: 'images/gallery/ch-Shenzhen-day.jpg', country: 'china',
    title: 'Shenzhen Cityscape — Day',
    desc: 'The bustling urban landscape of Shenzhen under the daylight.' },
  { src: 'images/gallery/ch-Shenzhen-night.jpg', country: 'china',
    title: 'Shenzhen Cityscape — Night',
    desc: 'The impressive skyline of Shenzhen illuminating the night sky.' },
  { src: 'images/gallery/ch-Xixiang.jpg', country: 'china',
    title: 'Xixiang Area — Shenzhen',
    desc: 'A glimpse into the local atmosphere of the Xixiang district.' },
  { src: 'images/gallery/ch-animal.jpg', country: 'china',
    title: 'Local Wildlife',
    desc: 'A captured moment of local fauna.' },
